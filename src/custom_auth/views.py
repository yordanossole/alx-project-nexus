...
from .serializers import AuthTokenSerializer, RegisterSerializer, SocialAccountSerializer, LoginAttemptSerializer
from .models import LoginAttempt, PasswordResetToken, SocialAccount, AuthToken
...
class LoginView(APIView):
    ...
    def post(self, request):
        ...
        if user is not None:
            ...
            return Response({
                "token": token.key,
                "access": UserProfileSerializer(user).data, 
